...
//{
    ...
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "resho_api1.yahoo.com";
        private string APIPassword = "EQK9DKA2S4JJQ5UN";
        private string APISignature = "AACr1Zc-R4LNmQej.yr52JmqF2gYA0siNx3l2pt3nXFKuJk0VHSViDS6";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            encoder["BRANDNAME"] = "LuminoWay Application";
            ...
            using (LuminoWay.Logic.ShoppingCartActions myCartOrders = new LuminoWay.Logic.ShoppingCartActions())
            {
